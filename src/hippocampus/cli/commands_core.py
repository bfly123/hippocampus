...
from .commands_pipeline import register_pipeline_commands
from .commands_project_bootstrap import register_project_bootstrap_commands
from .commands_structure_prompt import register_structure_prompt_commands
